...
export default {
    ...
    data: () => ({
        stats: [
            { name: 'Clients', stat: '71,897', previousStat: '70,946', change: '12%', changeType: 'increase' },
            { name: 'Leads', stat: '58.16%', previousStat: '56.14%', change: '2.02%', changeType: 'increase' },
            { name: 'Leads Won', stat: '24.57%', previousStat: '28.62%', change: '4.05%', changeType: 'decrease' },
        ]
    })
}
</script>
