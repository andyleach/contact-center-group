    ...
    export default {
        ...
        data: () => ({
            ...
            navigation: [
                ...
                { name: 'Clients', href: route('clients.index'), icon: UsersIcon, current: route().current('clients.index') },
            ],
            userNavigation: [
                { name: 'Your Profile', href: route('profile.show'), canShow: true },
                { name: 'API Tokens', href: '#', canShow: true},
            ]
        }),

        mounted() {
            this.userData = {
                name: this.page.props.user.displayName,
                email: this.page.props.user.email,
                imageUrl: this.page.props.user.profile_photo_url
            }
        },
